...
getClass(REG_VAL_TYPE* prob_class) {
    const REG_VAL_TYPE mean[TRACKER_NUM_FEATURES * TRACKER_NUM_CLASSES] = {0.25307806, 0.21680997, 0.18862757, 11.483962,
                                                                     0.60996965, 0.7063934,  0.41486924, 15.43389935,
                                                                     0.0419608,  0.04912008, 0.04823104, 9.76847904};

    const REG_VAL_TYPE std[TRACKER_NUM_FEATURES * TRACKER_NUM_CLASSES]  = {0.1172738,  0.11280127, 0.14980334, 1.2231232,
